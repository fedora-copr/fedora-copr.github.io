...
- We did [five releases of Copr](https://docs.copr.fedorainfracloud.org/release_notes.html) and upgraded Copr servers to Fedora 39.
...
- Long builds can be [run on high-performance builders](https://docs.copr.fedorainfracloud.org/user_documentation/powerful_builders.html) now.
...
- openEuler (Huawei)[ deployed their own instance](https://docs.copr.fedorainfracloud.org/user_documentation.html#public-copr-instances) of Copr and contributed back with several fixes and features. E.g., ["group" support for OIDC](https://github.com/fedora-copr/copr/issues/2788).
...
- Jakub documented Copr-specific [RPM macros](https://docs.copr.fedorainfracloud.org/user_documentation.html#rpm-macros).
- Pavel created the Copr plugin for DNF5.
- We documented [Pagure integration](https://docs.copr.fedorainfracloud.org/user_documentation/pagure_integration.html).
