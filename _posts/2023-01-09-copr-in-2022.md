...
Copr:
* We did [nine releases of Copr](https://docs.copr.fedorainfracloud.org/release_notes.html) and upgraded Copr servers to Fedora 37.
...
* We spent lots of time optimizing the scheduler in Copr. E.g.
    * Builds from webhooks are now background jobs [https://docs.copr.fedorainfracloud.org/release-notes/2022-02-03.html#webhook-rebuilds-are-background-jobs-now](https://docs.copr.fedorainfracloud.org/release-notes/2022-02-03.html#webhook-rebuilds-are-background-jobs-now)
    * We improved the throughput when the queue is bigger than 70k jobs [https://docs.copr.fedorainfracloud.org/release-notes/2022-03-21.html#large-queue-improvements](https://docs.copr.fedorainfracloud.org/release-notes/2022-03-21.html#large-queue-improvements)
    * And we were able to increase quota of parallel builds from one user from 35 to 45.
* We started using SHA256 for signing packages [https://docs.copr.fedorainfracloud.org/release-notes/2022-03-21.html#signing-packages-with-sha256](https://docs.copr.fedorainfracloud.org/release-notes/2022-03-21.html#signing-packages-with-sha256)
...
* We created a webUI statistics page that shows the utilization of [resalloc](https://github.com/praiskup/resalloc) resources https://docs.copr.fedorainfracloud.org/release-notes/2022-06-22.html#resalloc-webui
* We (finally) were able to count download statistics from CDN [https://docs.copr.fedorainfracloud.org/release-notes/2022-08-18.html#rpm-download-statistics](https://docs.copr.fedorainfracloud.org/release-notes/2022-08-18.html#rpm-download-statistics)
* You can submit more builds at once from command line [https://docs.copr.fedorainfracloud.org/release-notes/2022-07-27.html#submitting-multiple-builds-at-once-via-copr-cli](https://docs.copr.fedorainfracloud.org/release-notes/2022-07-27.html#submitting-multiple-builds-at-once-via-copr-cli)
* We upgraded aarch64 builders to stronger Graviton3 machines [https://docs.copr.fedorainfracloud.org/release-notes/2022-11-28.html#updated-aarch64-builders-to-graviton3-processors](https://docs.copr.fedorainfracloud.org/release-notes/2022-11-28.html#updated-aarch64-builders-to-graviton3-processors)
* We migrated our git project to GitHub [https://docs.copr.fedorainfracloud.org/release-notes/2022-11-28.html#development-moved-to-github](https://docs.copr.fedorainfracloud.org/release-notes/2022-11-28.html#development-moved-to-github)
