...
- Jakub updated the Copr [screenshot tutorial](https://docs.copr.fedorainfracloud.org/screenshots_tutorial.html)
...
- Jakub created [a video tutorial documentation page for Copr](https://docs.copr.fedorainfracloud.org/video_tutorial.html#video-tutorial)
